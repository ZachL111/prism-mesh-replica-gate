...
`prism-mesh-replica-gate` is centered on distributed systems work in SQL. The technical target is: Implement an SQL distributed systems project for replica event replay, using fixture event logs and golden state snapshots.
...
The score is deterministic. The current threshold is 170. Risk has a penalty of 6, latency has a penalty of 3, and weight contributes a bonus of 6.
